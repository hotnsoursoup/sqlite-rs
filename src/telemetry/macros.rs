...
//! code; the `__sqlite_kit_*` names are internal implementation details.

#[doc(hidden)]
#[cfg(feature = "tracing")]
#[macro_export]
macro_rules! __sqlite_kit_trace {
...
#[cfg(feature = "tracing")]
#[macro_export]
macro_rules! __sqlite_kit_debug {
...
#[cfg(feature = "tracing")]
#[macro_export]
macro_rules! __sqlite_kit_error {
